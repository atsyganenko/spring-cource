...
<div class="container">
    ...
    <form name = "event" action="/events/add" method="post">
        ...
        <div class="input-group">
            ...
            <input class="form-control" type="text" id="auditorium" name="auditorium.name" placeholder="Blue hall"/>
        </div>
        <div class="input-group">
            <label for="date">Date:</label>
            <input class="form-control" type="datetime-local" id="date" name="dateTime" placeholder="Select Date"/>
        </div>
